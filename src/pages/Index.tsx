...
const Index = () => {
  ...
  return (
    <div className="h-screen flex flex-col cozy-background relative">
      ...
      <div className="fixed top-4 left-4 right-4 bottom-4 flex flex-col max-w-4xl mx-auto h-[calc(100vh-2rem)] z-20 backdrop-blur-md bg-background/70 dark:bg-background/50 rounded-lg">
        <ChatHeader />
